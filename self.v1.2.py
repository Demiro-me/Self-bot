...
def answer(client, callback_query):
    global app
    global ID , STN , STB ,STB ,FONT
    print(callback_query.data)
    if(callback_query.from_user.id == ID):
        if(callback_query.data == "page1"):
        ...
        elif(callback_query.data == "page2"):
                        bot.edit_inline_reply_markup(
                inline_message_id = callback_query.inline_message_id,
                reply_markup=InlineKeyboardMarkup(
                    [
        ...
        elif(callback_query.data == "page3"):
            bot.edit_inline_reply_markup(
                inline_message_id = callback_query.inline_message_id,
                reply_markup=InlineKeyboardMarkup(
                    [
            ...
            callback_query.answer(
                ...
                f"╚══════ ᴇɴᴅ  ════╝ \n",
                show_alert=True)       
        elif(callback_query.data == "font_0"): 
            callback_query.answer(
            f"╔═══ ᴄʟᴏᴄᴋ ꜰᴏɴᴛ ɪɴꜰᴏ‌ ══\n"+
            f"║✓ ꜰᴏɴᴛ ᴄʜᴀɴɢᴇᴅ \n"+
            ...
            sleep(1)
        elif(callback_query.data == "font_1"):
            FONT = 1
            while FONT == 1  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_2"): 
            FONT = 2
            while FONT == 2  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)         
        elif(callback_query.data == "font_3"): 
            FONT = 3
            while FONT == 3  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)   
        elif(callback_query.data == "font_4"): 
            FONT = 4
            while FONT == 4  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_5"): 
            FONT = 5
            while FONT == 5  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_6"): 
            FONT = 6
            while FONT == 6  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)          
        elif(callback_query.data == "font_7"): 
            FONT = 7
            while FONT == 7  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_8"): 
            FONT = 8
            while FONT == 8  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_9"): 
            FONT = 9
            while FONT == 9  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_10"): 
            FONT = 10
            while FONT == 10  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_11"): 
            FONT = 11 
            while FONT == 11  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_12"): 
            FONT = 12
            while FONT == 12  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_13"): 
            FONT = 13
            while FONT == 13  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT)) 
                sleep(1)
        elif(callback_query.data == "font_14"): 
            FONT = 14
            while FONT == 14  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_15"): 
            FONT = 15
            while FONT == 15  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)      
        elif(callback_query.data == "font_16"): 
            FONT = 16
            while FONT == 16  and STN == 1 :
                if (IRTime().second == 00) :
                    app.update_profile(last_name=time(index=FONT))
                sleep(1)
        elif(callback_query.data == "font_None"): 
            FONT = None
